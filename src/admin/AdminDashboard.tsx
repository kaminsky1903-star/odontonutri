...
export function AdminDashboard() {
  ...
  return <div className="admin-dashboard">
    ...
    <BreakdownTable title="Fuentes de tráfico" items={reportFor("sources")?.sources ?? []} pending={pending} periodControls={periodControls("sources")} note="Google Ads identifica visitas con marcador de anuncio o UTM de pago. Google (buscador común) corresponde a visitas desde Google sin una señal publicitaria. Un visitante puede volver desde distintas fuentes; no sumes las filas para obtener el total general."/>
